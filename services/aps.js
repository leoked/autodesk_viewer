...
const APS_CLIENT_ID="d4gSgLq4l9FgiKx2HQN2gNlqTigIFXFC";
const APS_CLIENT_SECRET="hAg4PHntHzsqNLV8";
const APS_BUCKET=APS_CLIENT_ID.toLowerCase() + '_tutorial_bucket';
